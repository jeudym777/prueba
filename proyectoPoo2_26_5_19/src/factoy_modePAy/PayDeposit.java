 ...
 * @author User
 */
public class PayDeposit extends Bill_General {

    public PayDeposit() {
    }

    public PayDeposit(String id, String idc, String nameClient, String day, String month, String year) {
        super(id,idc, nameClient, day, month, year);
    }

    @Override
    public void setType(String type) {
        super.setType("Deposit "); //To change body of generated methods, choose Tools | Templates.
    }
