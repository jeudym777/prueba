...
public class PayCredit extends Bill_General {

    public PayCredit() { 
        
    }

    public PayCredit(String id, String idc,  String nameClient, String day, String month, String year) {
        super(id, idc,nameClient, day, month, year);
    }

    @Override
    public void setType(String type) {
        super.setType("Credit "); //To change body of generated methods, choose Tools | Templates.
    }
