...
public class PayCard extends Bill_General {

    public PayCard() {
    }

    public PayCard(String id,String idc,  String nameClient, String day, String month, String year) {
        super(id, idc, nameClient, day, month, year);
    }

    @Override
    public void setType(String type) {
        super.setType("Card"); //To change body of generated methods, choose Tools | Templates.
    }
